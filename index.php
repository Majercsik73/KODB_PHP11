...
$routes = [
    "GET" => [
        "/KODB_PHP11/" => "homeHandler",
        "/KODB_PHP11/termekek" => "productListHandler"
    ],
    "POST" => [
        "/KODB_PHP11/termekek" => "createProductHandler"
    ]
];
...
function productListHandler()
{
    ...
    echo compileTemplate("./views/wrapper.php", [
        ...
        'activeLink' => "KODB_PHP11/termekek"
    ]);
}
...
function createProductHandler()
{
    ...
    header("Location: /KODB_PHP11/termekek?siker=1");
}
